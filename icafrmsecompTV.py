...
#admm-saa data rmse
d1 = np.load("saaresults9cm_noiseless/attrmse.npy")
#admm-saa mu TV
d2 = np.load("saaresults9cm_noiseless/attrmse_TVmu100.npy")
#admm-saa lambda TV
d3 = np.load("saaresults9cm_noiseless/attrmse_TVlam100.npy")
#admm-saa both TV consts.
d4 = np.load("saaresults9cm_noiseless/attrmse_TVmu100_TVlam100.npy")
...
savefig("figs/icafrmsecompTV.png",dpi=300)
