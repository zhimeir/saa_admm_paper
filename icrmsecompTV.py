...
#admm-saa data rmse
d1 = np.load("saaresults9cm_noiseless/datarmse.npy")
#admm-saa mu TV
d2 = np.load("saaresults9cm_noiseless/datarmse_TVmu100.npy")
#admm-saa lambda TV
d3 = np.load("saaresults9cm_noiseless/datarmse_TVlam100.npy")
#admm-saa both TV consts.
d4 = np.load("saaresults9cm_noiseless/datarmse_TVmu100_TVlam100.npy")
...
savefig("figs/icrmsecompTV.png",dpi=300)
